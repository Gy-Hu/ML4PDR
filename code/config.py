...
parser.add_argument('--gen_log', type=str, default='/home/gary/coding_env/ML4PDR/log/data_maker.log')
...
#
parser.add_argument('--log-dir', type=str, default='/home/gary/coding_env/ML4PDR/log/', help='log folder dir')
parser.add_argument('--model-dir', type=str, default='/home/gary/coding_env/ML4PDR/model/', help='model folder dir')
parser.add_argument('--data-dir', type=str, default='/home/gary/coding_env/ML4PDR/dataset/', help='data folder dir')
