...
if __name__ == '__main__':
    ...
    #args = parser.parse_args(['../dataset/aig_benchmark/hwmcc07_tip/ken.flash^12.C.aag', '-c']) #SAT, this case can cause memory exploration
    ...
    #args = parser.parse_args(['../dataset/aig_benchmark/hwmcc07_tip/eijk.S208o.S.aag', '-c','-s','ig']) #Found bug here
