...
if __name__ == '__main__':
    ...
    #args = parser.parse_args(['../dataset/aig_benchmark/hwmcc07_tip/eijk.S208o.S.aag', '-c','-d','off','-n','ig','-a','on']) #Found bug here
    ...
    if (args.fileName is not None) and (args.mode==0):
        ...
        if args.c:
            if solver.NN_guide_ig_time_sum != 0:
                print("TIME CONSUMING IN TOTAL: " + str((endTime - startTime).seconds) + "seconds")
                print("TIME CONSUMING: " + str((endTime - startTime).seconds - solver.NN_guide_ig_time_sum) + "seconds")                
            else:
