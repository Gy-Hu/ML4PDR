...
if __name__ == '__main__':
    ...
    subset_dir_lst = [subset_dir+str(i) for i in range(0,5)] # non-trival
    
    pool = ThreadPool(multiprocessing.cpu_count())
    results = []
    for subset in subset_dir_lst[:]:
        cmd = "python main.py --mode 1 -t 3600 -p " + subset + " -c -r on -n on -a on -th 0.6 -mn neuropdr_2022-06-09_12:27:41_last -inf_dev gpu"
