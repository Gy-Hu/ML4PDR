...
(assert
 ...
 (let (($x563 (and $x278 $x40 $x35 $x46 $x41 $x480 $x329 $x245 $x36 $x536 $x162 $x636 $x449)))
 (let (($x408 (not (and $x563 $x629 (and v22 v26 (and (not (and v30 $x55)) i10))))))
 (not (and $x408 (not (and (and $x141) $x695)))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
