...
(assert
 ...
 (let (($x549 (and $x278 $x569 $x529 $x352 $x36 $x259 $x235 $x647 $x642 $x295 $x416 $x187 $x383 $x409 $x674)))
 (let (($x374 (and $x549 $x405 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x552 $x139 $x414) (and $x54 v18 (not $x35)))))
 (not (and (not $x374) (not (and (and $x141) $x201)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
