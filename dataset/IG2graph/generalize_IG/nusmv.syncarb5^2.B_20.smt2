...
(assert
 ...
 (let (($x488 (not $x285)))
 (let (($x331 (not (and v14 $x70))))
 (let (($x674 (not (and v14 v22))))
 (let (($x409 (not (and v26 v14))))
 (let (($x383 (not (and v18 $x70))))
 (let (($x187 (not (and v18 v14))))
 (let (($x416 (not (and v18 v22))))
 (let (($x295 (not (and v26 v22))))
 (let (($x642 (not (and v26 $x70))))
 (let (($x647 (not (and v20 v26))))
 (let (($x235 (not (and v16 v22))))
 (let (($x259 (not (and v20 $x70))))
 (let (($x352 (not (and v18 v26))))
 (let (($x529 (not (and v22 $x70))))
 (let (($x569 (not (and v24 $x70))))
 ...
 (let (($x372 (and $x278 $x569 $x529 $x352 $x36 $x259 $x235 $x647 $x642 $x295 $x416 $x187 $x383 $x409 $x674 $x331)))
 (let (($x430 (and $x372 $x488 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x279 $x139 $x154) (and $x39 v22 $x54 (not $x35)))))
 (not (and (not $x430) (not (and (and $x141) $x285)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
