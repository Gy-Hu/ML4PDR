...
(assert
 ...
 (let (($x49 (and $x48 i6)))
 (let (($x503 (not (and $x35 (not v30_prime)))))
 (let (($x419 (not (and v30_prime v14))))
 (let (($x388 (not (and (not (and v30 $x55)) i10 (not v28_prime)))))
 (let (($x494 (not (and v28_prime (not (and (not (and v30 $x55)) i10))))))
 (let (($x368 (not (and $x70 (not v26_prime)))))
 (let (($x411 (not (and v26_prime v30))))
 (let (($x577 (not (and (not (and $x50 $x51)) i8 (not v24_prime)))))
 (let (($x438 (not (and v24_prime (not (and (not (and $x50 $x51)) i8))))))
 (let (($x599 (not (and v26 (not v22_prime)))))
 (let (($x296 (not (and v22_prime $x50))))
 (let (($x334 (not (and $x48 i6 (not v20_prime)))))
 (let (($x317 (not (and v20_prime (not $x49)))))
 (let (($x583 (not (and v22 (not v18_prime)))))
 (let (($x446 (not (and v18_prime $x45))))
 (let (($x286 (not (and (not (and $x40 $x41)) i4 (not v16_prime)))))
 (let (($x536 (not (and v16_prime (not (and (not (and $x40 $x41)) i4))))))
 (let (($x603 (not (and v18 (not v14_prime)))))
 (let (($x345 (not (and v14_prime $x40))))
 (let (($x597 (not (and $x38 i2 (not v12_prime)))))
 (let (($x398 (not (and v12_prime (not $x39)))))
 (let (($x233 (and $x398 $x597 $x345 $x603 $x536 $x286 $x446 $x583 $x317 $x334 $x296 $x599 $x438 $x577 $x411 $x368 $x494 $x388 $x419 $x503)))
 (let (($x601 (not $x390)))
 ...
 (let (($x188 (and (and $x278 $x40 $x46 $x35 $x41 $x495) $x601 $x233 (and $x49 $x39 v22 $x70))))
 (not (and (not $x188) (not (and (and $x141) $x390)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
