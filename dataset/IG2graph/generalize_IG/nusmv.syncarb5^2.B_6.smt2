...
(assert
 ...
 (let (($x154 (and (and $x278 $x40 $x35 $x46 $x41 $x436) $x587 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x192 $x139 $x492) (and v20_prime v12_prime v18_prime v26_prime))))
 (not (and (not $x154) (not (and (and $x141) $x569)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
