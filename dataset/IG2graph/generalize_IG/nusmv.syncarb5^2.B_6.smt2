...
(assert
 ...
 (let (($x489 (and (and $x278 $x40 $x45 $x46 $x35 $x41 $x568) (not $x598) $x495 (and v26 $x70 (not $x35)))))
 (not (and (not $x489) (not (and (and $x141) $x598))))))))))))))))))))))))))))))))))))
(check-sat)
