...
(assert
 ...
 (let (($x452 (and (and $x278 $x480 $x329 $x245 $x36 $x536 $x162 $x636 $x449 $x510 $x571 $x712) $x284 (and (and (not (and $x50 $x51)) i8) v18 (not $x35)))))
 (not (and (not $x452) (not (and (and $x141) $x373)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
