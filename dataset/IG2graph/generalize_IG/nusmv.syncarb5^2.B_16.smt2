...
(assert
 ...
 (let (($x351 (and (and $x278 $x436 $x503 $x36 $x438 $x550 $x561 $x332 $x670 $x473 $x693 $x488) $x416 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x178 $x139 $x700) (and v24_prime v14_prime v28_prime (not v30_prime)))))
 (not (and (not $x351) (not (and (and $x141) $x574))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
