...
(assert
 ...
 (let (($x350 (and (and $x278 $x40 $x45 $x35 $x46 $x41) (not $x382) (and (and (not (and $x50 $x51)) i8) v26 $x70 (not $x35)))))
 (not (and (not $x350) (not (and (and $x141) $x382))))))))))))))))))))))))))))))))))
(check-sat)
