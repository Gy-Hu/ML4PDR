...
(assert
 ...
 (let (($x505 (and (and $x278 $x40 $x45 $x46 $x35 $x41) (not $x206) $x373 (and (and (not (and $x50 $x51)) i8) v26 $x70 (not $x35)))))
 (not (and (not $x505) (not (and (and $x141) $x206)))))))))))))))))))))))))))))))))))
(check-sat)
