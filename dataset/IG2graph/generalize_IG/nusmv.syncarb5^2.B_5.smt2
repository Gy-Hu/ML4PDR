...
(assert
 ...
 (let (($x343 (and (and $x278 $x40 $x45 $x46 $x35 $x41) (not $x212) $x310 (and v26 $x70 (not $x35)))))
 (not (and (not $x343) (not (and (and $x141) $x212)))))))))))))))))))))))))))))))))))
(check-sat)
