...
(assert
 ...
 (let (($x522 (and (and $x278 $x40 $x45 $x35 $x46 $x41) $x350 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x443 $x139 $x381) (and v22_prime v26_prime (not v30_prime)))))
 (not (and (not $x522) (not (and (and $x141) $x155))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
