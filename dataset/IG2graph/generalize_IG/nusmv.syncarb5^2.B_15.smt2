...
(assert
 ...
 (let (($x511 (and $x278 $x35 $x41 $x480 $x329 $x245 $x36 $x536 $x162 $x636 $x449 $x510 $x571)))
 (let (($x299 (and (not (and $x511 $x494 (and $x49 v18 $x58 $x70))) (not (and (and $x141) $x390)))))
 (not $x299))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
