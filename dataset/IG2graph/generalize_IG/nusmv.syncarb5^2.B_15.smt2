...
(assert
 ...
 (let (($x529 (and $x278 $x35 $x41 $x436 $x503 $x36 $x438 $x550 $x561 $x332 $x670 $x473 $x693)))
 (let (($x401 (and $x529 $x430 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x677 $x139 $x597) (and v24_prime v14_prime (not v30_prime)))))
 (not (and (not $x401) (not (and (and $x141) $x434))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
