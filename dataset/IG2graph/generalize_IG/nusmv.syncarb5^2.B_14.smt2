...
(assert
 ...
 (let (($x477 (and (and $x278 $x35 $x41 $x480 $x329 $x245 $x36 $x536 $x162 $x636 $x449 $x510) $x492 (and v22 v18 (and (not (and v30 $x55)) i10)))))
 (not (and (not $x477) (not (and (and $x141) $x366)))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
