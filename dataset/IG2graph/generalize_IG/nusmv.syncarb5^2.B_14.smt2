...
(assert
 ...
 (let (($x617 (and (and $x278 $x35 $x41 $x436 $x503 $x36 $x438 $x550 $x561 $x332 $x670 $x473) $x175 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x505 $x139 $x587) (and v20_prime v14_prime v28_prime v26_prime))))
 (not (and (not $x617) (not (and (and $x141) $x682))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
