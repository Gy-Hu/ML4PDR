...
(assert
 ...
 (let (($x290 (and (and $x278 $x40 $x45 $x35 $x46 $x41 $x436 $x503 $x36 $x438 $x550 $x561) $x156 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x323 $x139 $x508) (and v26_prime v22_prime v28_prime))))
 (not (and (not $x290) (not (and (and $x141) $x316)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
