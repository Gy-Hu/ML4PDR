...
(assert
 ...
 (let (($x409 (and (and $x278 $x40 $x46 $x35 $x41 $x495 $x515 $x36) (not $x283) $x530 (and (and (not (and $x45 $x46)) i6) $x70 (not $x35)))))
 (not (and (not $x409) (not (and (and $x141) $x283)))))))))))))))))))))))))))))))))))))
(check-sat)
