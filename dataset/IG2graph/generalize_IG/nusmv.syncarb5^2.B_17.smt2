...
(assert
 ...
 (let (($x365 (and $x278 $x40 $x35 $x46 $x41 $x436 $x503 $x36 $x438 $x550 $x561 $x332 $x670 $x473 $x693 $x488 $x692)))
 (let (($x502 (and $x365 $x553 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x176 $x139 $x212) (and v18_prime (not v30_prime)))))
 (not (and (not $x502) (not (and (and $x141) $x178))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
