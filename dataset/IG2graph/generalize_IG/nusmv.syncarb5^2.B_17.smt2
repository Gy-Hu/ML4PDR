...
(assert
 ...
 (let (($x667 (and $x278 $x480 $x329 $x245 $x36 $x536 $x162 $x636 $x449 $x510 $x571 $x712 $x460)))
 (let (($x351 (and (not (and $x667 $x298 (and $x39 $x54 v22 (not $x35)))) (not (and (and $x141) $x663)))))
 (not $x351))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
