...
(assert
 ...
 (let (($x359 (and $x278 $x40 $x45 $x35 $x46 $x41 $x480 $x329 $x245 $x36 $x536 $x162 $x636)))
 (let (($x462 (not (and $x359 $x397 (and $x70 v26 (and (not (and v30 $x55)) i10))))))
 (not (and $x462 (not (and (and $x141) $x449))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
