...
(assert
 ...
 (let (($x747 (not $x737)))
 (let (($x486 (not (and v18 $x70))))
 (let (($x692 (not (and v14 $x70))))
 (let (($x488 (not (and v24 $x70))))
 (let (($x693 (not (and v20 v26))))
 (let (($x473 (not (and v18 v14))))
 (let (($x670 (not (and v18 v22))))
 ...
 (let (($x700 (and $x278 $x35 $x41 $x436 $x503 $x36 $x438 $x550 $x561 $x332 $x670 $x473 $x693 $x488 $x692 $x486)))
 (let (($x607 (and $x700 $x747 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x754 $x139 $x749) (and v16_prime v26_prime v14_prime))))
 (not (and (not $x607) (not (and (and $x141) $x737)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
