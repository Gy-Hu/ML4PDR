...
(assert
 ...
 (let (($x298 (not $x530)))
 (let (($x462 (not (and v18 $x70))))
 (let (($x460 (not (and v14 $x70))))
 (let (($x712 (not (and v20 v26))))
 (let (($x571 (not (and v18 v14))))
 (let (($x510 (not (and v18 v22))))
 (let (($x449 (not (and v26 v22))))
 (let (($x636 (not (and v26 $x70))))
 (let (($x162 (not (and v14 v22))))
 ...
 (let (($x302 (and $x278 $x35 $x41 $x480 $x329 $x245 $x36 $x536 $x162 $x636 $x449 $x510 $x571 $x712 $x460 $x462)))
 (let (($x204 (not (and $x302 $x298 (and (and (not (and $x40 $x41)) i4) $x70 v18)))))
 (not (and $x204 (not (and (and $x141) $x530))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
