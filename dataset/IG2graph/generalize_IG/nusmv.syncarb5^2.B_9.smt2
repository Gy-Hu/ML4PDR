...
(assert
 ...
 (let (($x629 (and (and $x278 $x35 $x41 $x436 $x503 $x36 $x438) $x294 (and $x131 $x132 $x133 $x134 $x135 $x136 $x137 $x452 $x139 $x296) (and v18_prime v14_prime v28_prime v22_prime))))
 (not (and (not $x629) (not (and (and $x141) $x192)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
