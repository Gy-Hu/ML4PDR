...
(assert
 ...
 (let (($x364 (and (and $x278 $x40 $x46 $x35 $x41 $x568 $x482 $x599 $x36) (not $x302) $x562 (and (and (not (and $x45 $x46)) i6) $x70 (not $x35)))))
 (not (and (not $x364) (not (and (and $x141) $x302))))))))))))))))))))))))))))))))))))))
(check-sat)
