...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x866 (not (and $x470 i2_prime (not $x75) $x288 $x901 $x956 $x1084 $x508 i6_prime))))
 (let (($x432 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x961 (and $x470 i2_prime (not $x75) (not $x288) $x290 $x901 $x956 $x1084 $x508 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x687 (not (and $x851 i2_prime (not $x142) $x302 $x611 $x458 $x351 $x1035 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x680 (and $x851 i2_prime (not $x142) (not $x302) $x304 $x611 $x458 $x351 $x1035 i4_prime)))
 (let (($x554 (and (not $x680) (not (and $x458 i2_prime $x611 $x309 i14_prime)) (not (and $x458 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x432 $x687 (not (and $x851 i2_prime $x142 $x611 $x458 $x351 $x1035 i8_prime)) (not (and $x299 i2_prime $x611 $x458 $x351 $x1035 i10_prime)) (not (and $x458 i2_prime $x611 $x1035 $x311 i12_prime)))))
 (let (($x469 (and (not $x554) (not $x961) (not (and $x956 i2_prime $x901 $x295 i14_prime)) (not (and $x956 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x432 $x866 (not (and $x470 i2_prime $x75 $x901 $x956 $x1084 $x508 i8_prime)) (not (and $x285 i2_prime $x901 $x956 $x1084 $x508 i10_prime)) (not (and $x956 i2_prime $x901 $x508 $x297 i12_prime)))))
 (let (($x452 (and (not $x961) (not (and $x956 i2_prime $x901 $x295 i14_prime)) (not (and $x956 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x432 $x866 (not (and $x470 i2_prime $x75 $x901 $x956 $x1084 $x508 i8_prime)) (not (and $x285 i2_prime $x901 $x956 $x1084 $x508 i10_prime)) (not (and $x956 i2_prime $x901 $x508 $x297 i12_prime)))))
 (let (($x553 (and (not $x680) (not (and $x458 i2_prime $x611 $x309 i14_prime)) (not (and $x458 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x432 $x687 (not (and $x851 i2_prime $x142 $x611 $x458 $x351 $x1035 i8_prime)) (not (and $x299 i2_prime $x611 $x458 $x351 $x1035 i10_prime)) (not (and $x458 i2_prime $x611 $x1035 $x311 i12_prime)) (not $x452))))
 (not (not (and (not $x553) (not $x469))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
