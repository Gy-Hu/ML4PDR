...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x820 (not (and $x616 i2_prime (not $x75) $x288 $x357 $x417 $x727 $x1082 i6_prime))))
 (let (($x430 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x341 (and $x616 i2_prime (not $x75) (not $x288) $x290 $x357 $x417 $x727 $x1082 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x441 (not (and $x655 i2_prime (not $x142) $x302 $x409 $x841 $x769 $x941 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x1042 (and $x655 i2_prime (not $x142) (not $x302) $x304 $x409 $x841 $x769 $x941 i4_prime)))
 (let (($x910 (and (not $x1042) (not (and $x841 i2_prime $x409 $x309 i14_prime)) (not (and $x841 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x430 $x441 (not (and $x655 i2_prime $x142 $x409 $x841 $x769 $x941 i8_prime)) (not (and $x299 i2_prime $x409 $x841 $x769 $x941 i10_prime)) (not (and $x841 i2_prime $x409 $x941 $x311 i12_prime)))))
 (let (($x490 (and (not $x910) (not $x341) (not (and $x417 i2_prime $x357 $x295 i14_prime)) (not (and $x417 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x430 $x820 (not (and $x616 i2_prime $x75 $x357 $x417 $x727 $x1082 i8_prime)) (not (and $x285 i2_prime $x357 $x417 $x727 $x1082 i10_prime)) (not (and $x417 i2_prime $x357 $x1082 $x297 i12_prime)))))
 (let (($x878 (and (not $x341) (not (and $x417 i2_prime $x357 $x295 i14_prime)) (not (and $x417 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x430 $x820 (not (and $x616 i2_prime $x75 $x357 $x417 $x727 $x1082 i8_prime)) (not (and $x285 i2_prime $x357 $x417 $x727 $x1082 i10_prime)) (not (and $x417 i2_prime $x357 $x1082 $x297 i12_prime)))))
 (let (($x1049 (and (not $x1042) (not (and $x841 i2_prime $x409 $x309 i14_prime)) (not (and $x841 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x430 $x441 (not (and $x655 i2_prime $x142 $x409 $x841 $x769 $x941 i8_prime)) (not (and $x299 i2_prime $x409 $x841 $x769 $x941 i10_prime)) (not (and $x841 i2_prime $x409 $x941 $x311 i12_prime)) (not $x878))))
 (not (not (and (not $x1049) (not $x490))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
