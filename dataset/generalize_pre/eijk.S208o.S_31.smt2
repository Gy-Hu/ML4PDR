...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x507 (not (and $x722 i2_prime (not $x75) $x288 $x711 $x497 $x603 $x434 i6_prime))))
 (let (($x544 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x586 (and $x722 i2_prime (not $x75) (not $x288) $x290 $x711 $x497 $x603 $x434 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x706 (not (and $x340 i2_prime (not $x142) $x302 $x906 $x418 $x386 $x565 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x437 (and $x340 i2_prime (not $x142) (not $x302) $x304 $x906 $x418 $x386 $x565 i4_prime)))
 (let (($x545 (and (not $x437) (not (and $x418 i2_prime $x906 $x309 i14_prime)) (not (and $x418 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x544 $x706 (not (and $x340 i2_prime $x142 $x906 $x418 $x386 $x565 i8_prime)) (not (and $x299 i2_prime $x906 $x418 $x386 $x565 i10_prime)) (not (and $x418 i2_prime $x906 $x565 $x311 i12_prime)))))
 (let (($x429 (and (not $x545) (not $x586) (not (and $x497 i2_prime $x711 $x295 i14_prime)) (not (and $x497 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x544 $x507 (not (and $x722 i2_prime $x75 $x711 $x497 $x603 $x434 i8_prime)) (not (and $x285 i2_prime $x711 $x497 $x603 $x434 i10_prime)) (not (and $x497 i2_prime $x711 $x434 $x297 i12_prime)))))
 (let (($x866 (and (not $x586) (not (and $x497 i2_prime $x711 $x295 i14_prime)) (not (and $x497 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x544 $x507 (not (and $x722 i2_prime $x75 $x711 $x497 $x603 $x434 i8_prime)) (not (and $x285 i2_prime $x711 $x497 $x603 $x434 i10_prime)) (not (and $x497 i2_prime $x711 $x434 $x297 i12_prime)))))
 (let (($x512 (and (not $x437) (not (and $x418 i2_prime $x906 $x309 i14_prime)) (not (and $x418 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x544 $x706 (not (and $x340 i2_prime $x142 $x906 $x418 $x386 $x565 i8_prime)) (not (and $x299 i2_prime $x906 $x418 $x386 $x565 i10_prime)) (not (and $x418 i2_prime $x906 $x565 $x311 i12_prime)) (not $x866))))
 (not (not (and (not $x512) (not $x429))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
