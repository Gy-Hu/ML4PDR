...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x559 (not (and $x1045 i2_prime (not $x75) $x288 $x1021 $x740 $x898 $x967 i6_prime))))
 (let (($x341 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x993 (and $x1045 i2_prime (not $x75) (not $x288) $x290 $x1021 $x740 $x898 $x967 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x368 (not (and $x506 i2_prime (not $x142) $x302 $x489 $x932 $x403 $x1026 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x394 (and $x506 i2_prime (not $x142) (not $x302) $x304 $x489 $x932 $x403 $x1026 i4_prime)))
 (let (($x445 (and (not $x394) (not (and $x932 i2_prime $x489 $x309 i14_prime)) (not (and $x932 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x341 $x368 (not (and $x506 i2_prime $x142 $x489 $x932 $x403 $x1026 i8_prime)) (not (and $x299 i2_prime $x489 $x932 $x403 $x1026 i10_prime)) (not (and $x932 i2_prime $x489 $x1026 $x311 i12_prime)))))
 (let (($x744 (and (not $x445) (not $x993) (not (and $x740 i2_prime $x1021 $x295 i14_prime)) (not (and $x740 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x341 $x559 (not (and $x1045 i2_prime $x75 $x1021 $x740 $x898 $x967 i8_prime)) (not (and $x285 i2_prime $x1021 $x740 $x898 $x967 i10_prime)) (not (and $x740 i2_prime $x1021 $x967 $x297 i12_prime)))))
 (let (($x363 (and (not $x993) (not (and $x740 i2_prime $x1021 $x295 i14_prime)) (not (and $x740 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x341 $x559 (not (and $x1045 i2_prime $x75 $x1021 $x740 $x898 $x967 i8_prime)) (not (and $x285 i2_prime $x1021 $x740 $x898 $x967 i10_prime)) (not (and $x740 i2_prime $x1021 $x967 $x297 i12_prime)))))
 (let (($x1047 (and (not $x394) (not (and $x932 i2_prime $x489 $x309 i14_prime)) (not (and $x932 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x341 $x368 (not (and $x506 i2_prime $x142 $x489 $x932 $x403 $x1026 i8_prime)) (not (and $x299 i2_prime $x489 $x932 $x403 $x1026 i10_prime)) (not (and $x932 i2_prime $x489 $x1026 $x311 i12_prime)) (not $x363))))
 (not (not (and (not $x1047) (not $x744))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
