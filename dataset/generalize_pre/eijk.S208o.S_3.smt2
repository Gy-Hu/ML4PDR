...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x940 (not (and $x957 i2_prime (not $x75) $x288 $x828 $x499 $x393 $x414 i6_prime))))
 (let (($x347 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x928 (and $x957 i2_prime (not $x75) (not $x288) $x290 $x828 $x499 $x393 $x414 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x896 (not (and $x948 i2_prime (not $x142) $x302 $x775 $x621 $x934 $x1056 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x646 (and $x948 i2_prime (not $x142) (not $x302) $x304 $x775 $x621 $x934 $x1056 i4_prime)))
 (let (($x368 (and (not $x646) (not (and $x621 i2_prime $x775 $x309 i14_prime)) (not (and $x621 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x347 $x896 (not (and $x948 i2_prime $x142 $x775 $x621 $x934 $x1056 i8_prime)) (not (and $x299 i2_prime $x775 $x621 $x934 $x1056 i10_prime)) (not (and $x621 i2_prime $x775 $x1056 $x311 i12_prime)))))
 (let (($x705 (and (not $x368) (not $x928) (not (and $x499 i2_prime $x828 $x295 i14_prime)) (not (and $x499 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x347 $x940 (not (and $x957 i2_prime $x75 $x828 $x499 $x393 $x414 i8_prime)) (not (and $x285 i2_prime $x828 $x499 $x393 $x414 i10_prime)) (not (and $x499 i2_prime $x828 $x414 $x297 i12_prime)))))
 (let (($x655 (and (not $x928) (not (and $x499 i2_prime $x828 $x295 i14_prime)) (not (and $x499 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x347 $x940 (not (and $x957 i2_prime $x75 $x828 $x499 $x393 $x414 i8_prime)) (not (and $x285 i2_prime $x828 $x499 $x393 $x414 i10_prime)) (not (and $x499 i2_prime $x828 $x414 $x297 i12_prime)))))
 (let (($x579 (and (not $x646) (not (and $x621 i2_prime $x775 $x309 i14_prime)) (not (and $x621 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x347 $x896 (not (and $x948 i2_prime $x142 $x775 $x621 $x934 $x1056 i8_prime)) (not (and $x299 i2_prime $x775 $x621 $x934 $x1056 i10_prime)) (not (and $x621 i2_prime $x775 $x1056 $x311 i12_prime)) (not $x655))))
 (not (not (and (not $x579) (not $x705))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
