...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x1096 (not (and $x499 i2_prime (not $x75) $x288 $x348 $x470 $x914 $x358 i6_prime))))
 (let (($x921 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x870 (and $x499 i2_prime (not $x75) (not $x288) $x290 $x348 $x470 $x914 $x358 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x827 (not (and $x739 i2_prime (not $x142) $x302 $x723 $x947 $x369 $x1045 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x627 (and $x739 i2_prime (not $x142) (not $x302) $x304 $x723 $x947 $x369 $x1045 i4_prime)))
 (let (($x489 (and (not $x627) (not (and $x947 i2_prime $x723 $x309 i14_prime)) (not (and $x947 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x921 $x827 (not (and $x739 i2_prime $x142 $x723 $x947 $x369 $x1045 i8_prime)) (not (and $x299 i2_prime $x723 $x947 $x369 $x1045 i10_prime)) (not (and $x947 i2_prime $x723 $x1045 $x311 i12_prime)))))
 (let (($x974 (and (not $x489) (not $x870) (not (and $x470 i2_prime $x348 $x295 i14_prime)) (not (and $x470 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x921 $x1096 (not (and $x499 i2_prime $x75 $x348 $x470 $x914 $x358 i8_prime)) (not (and $x285 i2_prime $x348 $x470 $x914 $x358 i10_prime)) (not (and $x470 i2_prime $x348 $x358 $x297 i12_prime)))))
 (let (($x659 (and (not $x870) (not (and $x470 i2_prime $x348 $x295 i14_prime)) (not (and $x470 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x921 $x1096 (not (and $x499 i2_prime $x75 $x348 $x470 $x914 $x358 i8_prime)) (not (and $x285 i2_prime $x348 $x470 $x914 $x358 i10_prime)) (not (and $x470 i2_prime $x348 $x358 $x297 i12_prime)))))
 (let (($x876 (and (not $x627) (not (and $x947 i2_prime $x723 $x309 i14_prime)) (not (and $x947 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x921 $x827 (not (and $x739 i2_prime $x142 $x723 $x947 $x369 $x1045 i8_prime)) (not (and $x299 i2_prime $x723 $x947 $x369 $x1045 i10_prime)) (not (and $x947 i2_prime $x723 $x1045 $x311 i12_prime)) (not $x659))))
 (not (not (and (not $x876) (not $x974))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
