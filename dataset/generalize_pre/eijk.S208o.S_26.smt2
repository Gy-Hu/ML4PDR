...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x999 (not (and $x810 i2_prime (not $x75) $x288 $x751 $x1068 $x579 $x794 i6_prime))))
 (let (($x1050 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x898 (and $x810 i2_prime (not $x75) (not $x288) $x290 $x751 $x1068 $x579 $x794 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x366 (not (and $x1061 i2_prime (not $x142) $x302 $x737 $x872 $x1040 $x644 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x1011 (and $x1061 i2_prime (not $x142) (not $x302) $x304 $x737 $x872 $x1040 $x644 i4_prime)))
 (let (($x1038 (and (not $x1011) (not (and $x872 i2_prime $x737 $x309 i14_prime)) (not (and $x872 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x1050 $x366 (not (and $x1061 i2_prime $x142 $x737 $x872 $x1040 $x644 i8_prime)) (not (and $x299 i2_prime $x737 $x872 $x1040 $x644 i10_prime)) (not (and $x872 i2_prime $x737 $x644 $x311 i12_prime)))))
 (let (($x612 (and (not $x1038) (not $x898) (not (and $x1068 i2_prime $x751 $x295 i14_prime)) (not (and $x1068 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x1050 $x999 (not (and $x810 i2_prime $x75 $x751 $x1068 $x579 $x794 i8_prime)) (not (and $x285 i2_prime $x751 $x1068 $x579 $x794 i10_prime)) (not (and $x1068 i2_prime $x751 $x794 $x297 i12_prime)))))
 (let (($x1067 (and (not $x898) (not (and $x1068 i2_prime $x751 $x295 i14_prime)) (not (and $x1068 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x1050 $x999 (not (and $x810 i2_prime $x75 $x751 $x1068 $x579 $x794 i8_prime)) (not (and $x285 i2_prime $x751 $x1068 $x579 $x794 i10_prime)) (not (and $x1068 i2_prime $x751 $x794 $x297 i12_prime)))))
 (let (($x567 (and (not $x1011) (not (and $x872 i2_prime $x737 $x309 i14_prime)) (not (and $x872 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x1050 $x366 (not (and $x1061 i2_prime $x142 $x737 $x872 $x1040 $x644 i8_prime)) (not (and $x299 i2_prime $x737 $x872 $x1040 $x644 i10_prime)) (not (and $x872 i2_prime $x737 $x644 $x311 i12_prime)) (not $x1067))))
 (not (not (and (not $x567) (not $x612))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
