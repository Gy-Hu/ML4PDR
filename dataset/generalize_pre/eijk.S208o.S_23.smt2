...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x406 (not (and $x460 i2_prime (not $x75) $x288 $x1002 $x443 $x608 $x945 i6_prime))))
 (let (($x383 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x492 (and $x460 i2_prime (not $x75) (not $x288) $x290 $x1002 $x443 $x608 $x945 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x674 (not (and $x587 i2_prime (not $x142) $x302 $x990 $x387 $x792 $x615 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x462 (and $x587 i2_prime (not $x142) (not $x302) $x304 $x990 $x387 $x792 $x615 i4_prime)))
 (let (($x342 (and (not $x462) (not (and $x387 i2_prime $x990 $x309 i14_prime)) (not (and $x387 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x383 $x674 (not (and $x587 i2_prime $x142 $x990 $x387 $x792 $x615 i8_prime)) (not (and $x299 i2_prime $x990 $x387 $x792 $x615 i10_prime)) (not (and $x387 i2_prime $x990 $x615 $x311 i12_prime)))))
 (let (($x410 (and (not $x342) (not $x492) (not (and $x443 i2_prime $x1002 $x295 i14_prime)) (not (and $x443 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x383 $x406 (not (and $x460 i2_prime $x75 $x1002 $x443 $x608 $x945 i8_prime)) (not (and $x285 i2_prime $x1002 $x443 $x608 $x945 i10_prime)) (not (and $x443 i2_prime $x1002 $x945 $x297 i12_prime)))))
 (let (($x421 (and (not $x492) (not (and $x443 i2_prime $x1002 $x295 i14_prime)) (not (and $x443 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x383 $x406 (not (and $x460 i2_prime $x75 $x1002 $x443 $x608 $x945 i8_prime)) (not (and $x285 i2_prime $x1002 $x443 $x608 $x945 i10_prime)) (not (and $x443 i2_prime $x1002 $x945 $x297 i12_prime)))))
 (let (($x373 (and (not $x462) (not (and $x387 i2_prime $x990 $x309 i14_prime)) (not (and $x387 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x383 $x674 (not (and $x587 i2_prime $x142 $x990 $x387 $x792 $x615 i8_prime)) (not (and $x299 i2_prime $x990 $x387 $x792 $x615 i10_prime)) (not (and $x387 i2_prime $x990 $x615 $x311 i12_prime)) (not $x421))))
 (not (not (and (not $x373) (not $x410))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
