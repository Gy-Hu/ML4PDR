...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x646 (not (and $x790 i2_prime (not $x75) $x288 $x915 $x1066 $x656 $x718 i6_prime))))
 (let (($x715 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x734 (and $x790 i2_prime (not $x75) (not $x288) $x290 $x915 $x1066 $x656 $x718 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x655 (not (and $x658 i2_prime (not $x142) $x302 $x952 $x850 $x660 $x978 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x903 (and $x658 i2_prime (not $x142) (not $x302) $x304 $x952 $x850 $x660 $x978 i4_prime)))
 (let (($x979 (and (not $x903) (not (and $x850 i2_prime $x952 $x309 i14_prime)) (not (and $x850 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x715 $x655 (not (and $x658 i2_prime $x142 $x952 $x850 $x660 $x978 i8_prime)) (not (and $x299 i2_prime $x952 $x850 $x660 $x978 i10_prime)) (not (and $x850 i2_prime $x952 $x978 $x311 i12_prime)))))
 (let (($x898 (and (not $x979) (not $x734) (not (and $x1066 i2_prime $x915 $x295 i14_prime)) (not (and $x1066 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x715 $x646 (not (and $x790 i2_prime $x75 $x915 $x1066 $x656 $x718 i8_prime)) (not (and $x285 i2_prime $x915 $x1066 $x656 $x718 i10_prime)) (not (and $x1066 i2_prime $x915 $x718 $x297 i12_prime)))))
 (let (($x755 (and (not $x734) (not (and $x1066 i2_prime $x915 $x295 i14_prime)) (not (and $x1066 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x715 $x646 (not (and $x790 i2_prime $x75 $x915 $x1066 $x656 $x718 i8_prime)) (not (and $x285 i2_prime $x915 $x1066 $x656 $x718 i10_prime)) (not (and $x1066 i2_prime $x915 $x718 $x297 i12_prime)))))
 (let (($x947 (and (not $x903) (not (and $x850 i2_prime $x952 $x309 i14_prime)) (not (and $x850 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x715 $x655 (not (and $x658 i2_prime $x142 $x952 $x850 $x660 $x978 i8_prime)) (not (and $x299 i2_prime $x952 $x850 $x660 $x978 i10_prime)) (not (and $x850 i2_prime $x952 $x978 $x311 i12_prime)) (not $x755))))
 (not (not (and (not $x947) (not $x898))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
