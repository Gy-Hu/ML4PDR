...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x854 (not (and $x579 i2_prime (not $x75) $x288 $x788 $x940 $x801 $x460 i6_prime))))
 (let (($x688 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x990 (and $x579 i2_prime (not $x75) (not $x288) $x290 $x788 $x940 $x801 $x460 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x780 (not (and $x630 i2_prime (not $x142) $x302 $x348 $x408 $x593 $x885 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x972 (and $x630 i2_prime (not $x142) (not $x302) $x304 $x348 $x408 $x593 $x885 i4_prime)))
 (let (($x690 (and (not $x972) (not (and $x408 i2_prime $x348 $x309 i14_prime)) (not (and $x408 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x688 $x780 (not (and $x630 i2_prime $x142 $x348 $x408 $x593 $x885 i8_prime)) (not (and $x299 i2_prime $x348 $x408 $x593 $x885 i10_prime)) (not (and $x408 i2_prime $x348 $x885 $x311 i12_prime)))))
 (let (($x401 (and (not $x690) (not $x990) (not (and $x940 i2_prime $x788 $x295 i14_prime)) (not (and $x940 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x688 $x854 (not (and $x579 i2_prime $x75 $x788 $x940 $x801 $x460 i8_prime)) (not (and $x285 i2_prime $x788 $x940 $x801 $x460 i10_prime)) (not (and $x940 i2_prime $x788 $x460 $x297 i12_prime)))))
 (let (($x1057 (and (not $x990) (not (and $x940 i2_prime $x788 $x295 i14_prime)) (not (and $x940 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x688 $x854 (not (and $x579 i2_prime $x75 $x788 $x940 $x801 $x460 i8_prime)) (not (and $x285 i2_prime $x788 $x940 $x801 $x460 i10_prime)) (not (and $x940 i2_prime $x788 $x460 $x297 i12_prime)))))
 (let (($x904 (and (not $x972) (not (and $x408 i2_prime $x348 $x309 i14_prime)) (not (and $x408 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x688 $x780 (not (and $x630 i2_prime $x142 $x348 $x408 $x593 $x885 i8_prime)) (not (and $x299 i2_prime $x348 $x408 $x593 $x885 i10_prime)) (not (and $x408 i2_prime $x348 $x885 $x311 i12_prime)) (not $x1057))))
 (not (not (and (not $x904) (not $x401))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
