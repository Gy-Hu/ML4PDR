...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x589 (not (and $x446 i2_prime (not $x75) $x288 $x555 $x368 $x568 $x831 i6_prime))))
 (let (($x437 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x605 (and $x446 i2_prime (not $x75) (not $x288) $x290 $x555 $x368 $x568 $x831 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x423 (not (and $x961 i2_prime (not $x142) $x302 $x552 $x408 $x440 $x809 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x723 (and $x961 i2_prime (not $x142) (not $x302) $x304 $x552 $x408 $x440 $x809 i4_prime)))
 (let (($x433 (and (not $x723) (not (and $x408 i2_prime $x552 $x309 i14_prime)) (not (and $x408 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x437 $x423 (not (and $x961 i2_prime $x142 $x552 $x408 $x440 $x809 i8_prime)) (not (and $x299 i2_prime $x552 $x408 $x440 $x809 i10_prime)) (not (and $x408 i2_prime $x552 $x809 $x311 i12_prime)))))
 (let (($x703 (and (not $x433) (not $x605) (not (and $x368 i2_prime $x555 $x295 i14_prime)) (not (and $x368 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x437 $x589 (not (and $x446 i2_prime $x75 $x555 $x368 $x568 $x831 i8_prime)) (not (and $x285 i2_prime $x555 $x368 $x568 $x831 i10_prime)) (not (and $x368 i2_prime $x555 $x831 $x297 i12_prime)))))
 (let (($x782 (and (not $x605) (not (and $x368 i2_prime $x555 $x295 i14_prime)) (not (and $x368 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x437 $x589 (not (and $x446 i2_prime $x75 $x555 $x368 $x568 $x831 i8_prime)) (not (and $x285 i2_prime $x555 $x368 $x568 $x831 i10_prime)) (not (and $x368 i2_prime $x555 $x831 $x297 i12_prime)))))
 (let (($x660 (and (not $x723) (not (and $x408 i2_prime $x552 $x309 i14_prime)) (not (and $x408 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x437 $x423 (not (and $x961 i2_prime $x142 $x552 $x408 $x440 $x809 i8_prime)) (not (and $x299 i2_prime $x552 $x408 $x440 $x809 i10_prime)) (not (and $x408 i2_prime $x552 $x809 $x311 i12_prime)) (not $x782))))
 (not (not (and (not $x660) (not $x703))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
