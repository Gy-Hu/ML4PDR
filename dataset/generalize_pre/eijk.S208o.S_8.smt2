...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x843 (not (and $x957 i2_prime (not $x75) $x288 $x1077 $x801 $x511 $x671 i6_prime))))
 (let (($x385 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x837 (and $x957 i2_prime (not $x75) (not $x288) $x290 $x1077 $x801 $x511 $x671 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x1070 (not (and $x958 i2_prime (not $x142) $x302 $x395 $x1071 $x380 $x722 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x590 (and $x958 i2_prime (not $x142) (not $x302) $x304 $x395 $x1071 $x380 $x722 i4_prime)))
 (let (($x606 (and (not $x590) (not (and $x1071 i2_prime $x395 $x309 i14_prime)) (not (and $x1071 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x385 $x1070 (not (and $x958 i2_prime $x142 $x395 $x1071 $x380 $x722 i8_prime)) (not (and $x299 i2_prime $x395 $x1071 $x380 $x722 i10_prime)) (not (and $x1071 i2_prime $x395 $x722 $x311 i12_prime)))))
 (let (($x850 (and (not $x606) (not $x837) (not (and $x801 i2_prime $x1077 $x295 i14_prime)) (not (and $x801 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x385 $x843 (not (and $x957 i2_prime $x75 $x1077 $x801 $x511 $x671 i8_prime)) (not (and $x285 i2_prime $x1077 $x801 $x511 $x671 i10_prime)) (not (and $x801 i2_prime $x1077 $x671 $x297 i12_prime)))))
 (let (($x428 (and (not $x837) (not (and $x801 i2_prime $x1077 $x295 i14_prime)) (not (and $x801 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x385 $x843 (not (and $x957 i2_prime $x75 $x1077 $x801 $x511 $x671 i8_prime)) (not (and $x285 i2_prime $x1077 $x801 $x511 $x671 i10_prime)) (not (and $x801 i2_prime $x1077 $x671 $x297 i12_prime)))))
 (let (($x347 (and (not $x590) (not (and $x1071 i2_prime $x395 $x309 i14_prime)) (not (and $x1071 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x385 $x1070 (not (and $x958 i2_prime $x142 $x395 $x1071 $x380 $x722 i8_prime)) (not (and $x299 i2_prime $x395 $x1071 $x380 $x722 i10_prime)) (not (and $x1071 i2_prime $x395 $x722 $x311 i12_prime)) (not $x428))))
 (not (not (and (not $x347) (not $x850))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
