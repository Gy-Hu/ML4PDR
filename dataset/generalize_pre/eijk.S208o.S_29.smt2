...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x441 (not (and $x835 i2_prime (not $x75) $x288 $x374 $x373 $x875 $x1069 i6_prime))))
 (let (($x602 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x854 (and $x835 i2_prime (not $x75) (not $x288) $x290 $x374 $x373 $x875 $x1069 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x1023 (not (and $x859 i2_prime (not $x142) $x302 $x749 $x888 $x866 $x722 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x709 (and $x859 i2_prime (not $x142) (not $x302) $x304 $x749 $x888 $x866 $x722 i4_prime)))
 (let (($x563 (and (not $x709) (not (and $x888 i2_prime $x749 $x309 i14_prime)) (not (and $x888 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x602 $x1023 (not (and $x859 i2_prime $x142 $x749 $x888 $x866 $x722 i8_prime)) (not (and $x299 i2_prime $x749 $x888 $x866 $x722 i10_prime)) (not (and $x888 i2_prime $x749 $x722 $x311 i12_prime)))))
 (let (($x571 (and (not $x563) (not $x854) (not (and $x373 i2_prime $x374 $x295 i14_prime)) (not (and $x373 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x602 $x441 (not (and $x835 i2_prime $x75 $x374 $x373 $x875 $x1069 i8_prime)) (not (and $x285 i2_prime $x374 $x373 $x875 $x1069 i10_prime)) (not (and $x373 i2_prime $x374 $x1069 $x297 i12_prime)))))
 (let (($x640 (and (not $x854) (not (and $x373 i2_prime $x374 $x295 i14_prime)) (not (and $x373 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x602 $x441 (not (and $x835 i2_prime $x75 $x374 $x373 $x875 $x1069 i8_prime)) (not (and $x285 i2_prime $x374 $x373 $x875 $x1069 i10_prime)) (not (and $x373 i2_prime $x374 $x1069 $x297 i12_prime)))))
 (let (($x647 (and (not $x709) (not (and $x888 i2_prime $x749 $x309 i14_prime)) (not (and $x888 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x602 $x1023 (not (and $x859 i2_prime $x142 $x749 $x888 $x866 $x722 i8_prime)) (not (and $x299 i2_prime $x749 $x888 $x866 $x722 i10_prime)) (not (and $x888 i2_prime $x749 $x722 $x311 i12_prime)) (not $x640))))
 (not (not (and (not $x647) (not $x571))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
