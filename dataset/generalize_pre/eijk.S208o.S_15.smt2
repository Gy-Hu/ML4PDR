...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x680 (not (and $x1031 i2_prime (not $x75) $x288 $x989 $x767 $x575 $x940 i6_prime))))
 (let (($x960 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x620 (and $x1031 i2_prime (not $x75) (not $x288) $x290 $x989 $x767 $x575 $x940 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x923 (not (and $x782 i2_prime (not $x142) $x302 $x348 $x669 $x759 $x647 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x335 (and $x782 i2_prime (not $x142) (not $x302) $x304 $x348 $x669 $x759 $x647 i4_prime)))
 (let (($x1059 (and (not $x335) (not (and $x669 i2_prime $x348 $x309 i14_prime)) (not (and $x669 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x960 $x923 (not (and $x782 i2_prime $x142 $x348 $x669 $x759 $x647 i8_prime)) (not (and $x299 i2_prime $x348 $x669 $x759 $x647 i10_prime)) (not (and $x669 i2_prime $x348 $x647 $x311 i12_prime)))))
 (let (($x435 (and (not $x1059) (not $x620) (not (and $x767 i2_prime $x989 $x295 i14_prime)) (not (and $x767 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x960 $x680 (not (and $x1031 i2_prime $x75 $x989 $x767 $x575 $x940 i8_prime)) (not (and $x285 i2_prime $x989 $x767 $x575 $x940 i10_prime)) (not (and $x767 i2_prime $x989 $x940 $x297 i12_prime)))))
 (let (($x887 (and (not $x620) (not (and $x767 i2_prime $x989 $x295 i14_prime)) (not (and $x767 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x960 $x680 (not (and $x1031 i2_prime $x75 $x989 $x767 $x575 $x940 i8_prime)) (not (and $x285 i2_prime $x989 $x767 $x575 $x940 i10_prime)) (not (and $x767 i2_prime $x989 $x940 $x297 i12_prime)))))
 (let (($x734 (and (not $x335) (not (and $x669 i2_prime $x348 $x309 i14_prime)) (not (and $x669 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x960 $x923 (not (and $x782 i2_prime $x142 $x348 $x669 $x759 $x647 i8_prime)) (not (and $x299 i2_prime $x348 $x669 $x759 $x647 i10_prime)) (not (and $x669 i2_prime $x348 $x647 $x311 i12_prime)) (not $x887))))
 (not (not (and (not $x734) (not $x435))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
