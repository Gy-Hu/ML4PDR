...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x958 (not (and $x645 i2_prime (not $x75) $x288 $x649 $x1064 $x890 $x1006 i6_prime))))
 (let (($x504 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x1005 (and $x645 i2_prime (not $x75) (not $x288) $x290 $x649 $x1064 $x890 $x1006 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x1032 (not (and $x568 i2_prime (not $x142) $x302 $x1071 $x748 $x333 $x614 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x986 (and $x568 i2_prime (not $x142) (not $x302) $x304 $x1071 $x748 $x333 $x614 i4_prime)))
 (let (($x507 (and (not $x986) (not (and $x748 i2_prime $x1071 $x309 i14_prime)) (not (and $x748 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x504 $x1032 (not (and $x568 i2_prime $x142 $x1071 $x748 $x333 $x614 i8_prime)) (not (and $x299 i2_prime $x1071 $x748 $x333 $x614 i10_prime)) (not (and $x748 i2_prime $x1071 $x614 $x311 i12_prime)))))
 (let (($x600 (and (not $x507) (not $x1005) (not (and $x1064 i2_prime $x649 $x295 i14_prime)) (not (and $x1064 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x504 $x958 (not (and $x645 i2_prime $x75 $x649 $x1064 $x890 $x1006 i8_prime)) (not (and $x285 i2_prime $x649 $x1064 $x890 $x1006 i10_prime)) (not (and $x1064 i2_prime $x649 $x1006 $x297 i12_prime)))))
 (let (($x1057 (and (not $x1005) (not (and $x1064 i2_prime $x649 $x295 i14_prime)) (not (and $x1064 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x504 $x958 (not (and $x645 i2_prime $x75 $x649 $x1064 $x890 $x1006 i8_prime)) (not (and $x285 i2_prime $x649 $x1064 $x890 $x1006 i10_prime)) (not (and $x1064 i2_prime $x649 $x1006 $x297 i12_prime)))))
 (let (($x483 (and (not $x986) (not (and $x748 i2_prime $x1071 $x309 i14_prime)) (not (and $x748 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x504 $x1032 (not (and $x568 i2_prime $x142 $x1071 $x748 $x333 $x614 i8_prime)) (not (and $x299 i2_prime $x1071 $x748 $x333 $x614 i10_prime)) (not (and $x748 i2_prime $x1071 $x614 $x311 i12_prime)) (not $x1057))))
 (not (not (and (not $x483) (not $x600))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
