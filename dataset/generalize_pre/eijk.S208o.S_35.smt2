...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x675 (not (and $x496 i2_prime (not $x75) $x288 $x348 $x799 $x403 $x474 i6_prime))))
 (let (($x875 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x971 (and $x496 i2_prime (not $x75) (not $x288) $x290 $x348 $x799 $x403 $x474 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x706 (not (and $x938 i2_prime (not $x142) $x302 $x664 $x973 $x1010 $x818 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x582 (and $x938 i2_prime (not $x142) (not $x302) $x304 $x664 $x973 $x1010 $x818 i4_prime)))
 (let (($x812 (and (not $x582) (not (and $x973 i2_prime $x664 $x309 i14_prime)) (not (and $x973 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x875 $x706 (not (and $x938 i2_prime $x142 $x664 $x973 $x1010 $x818 i8_prime)) (not (and $x299 i2_prime $x664 $x973 $x1010 $x818 i10_prime)) (not (and $x973 i2_prime $x664 $x818 $x311 i12_prime)))))
 (let (($x1037 (and (not $x812) (not $x971) (not (and $x799 i2_prime $x348 $x295 i14_prime)) (not (and $x799 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x875 $x675 (not (and $x496 i2_prime $x75 $x348 $x799 $x403 $x474 i8_prime)) (not (and $x285 i2_prime $x348 $x799 $x403 $x474 i10_prime)) (not (and $x799 i2_prime $x348 $x474 $x297 i12_prime)))))
 (let (($x456 (and (not $x971) (not (and $x799 i2_prime $x348 $x295 i14_prime)) (not (and $x799 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x875 $x675 (not (and $x496 i2_prime $x75 $x348 $x799 $x403 $x474 i8_prime)) (not (and $x285 i2_prime $x348 $x799 $x403 $x474 i10_prime)) (not (and $x799 i2_prime $x348 $x474 $x297 i12_prime)))))
 (let (($x691 (and (not $x582) (not (and $x973 i2_prime $x664 $x309 i14_prime)) (not (and $x973 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x875 $x706 (not (and $x938 i2_prime $x142 $x664 $x973 $x1010 $x818 i8_prime)) (not (and $x299 i2_prime $x664 $x973 $x1010 $x818 i10_prime)) (not (and $x973 i2_prime $x664 $x818 $x311 i12_prime)) (not $x456))))
 (not (not (and (not $x691) (not $x1037))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
