...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x947 (not (and $x850 i2_prime (not $x75) $x288 $x964 $x794 $x745 $x789 i6_prime))))
 (let (($x729 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x362 (and $x850 i2_prime (not $x75) (not $x288) $x290 $x964 $x794 $x745 $x789 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x774 (not (and $x356 i2_prime (not $x142) $x302 $x344 $x835 $x1105 $x646 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x1051 (and $x356 i2_prime (not $x142) (not $x302) $x304 $x344 $x835 $x1105 $x646 i4_prime)))
 (let (($x685 (and (not $x1051) (not (and $x835 i2_prime $x344 $x309 i14_prime)) (not (and $x835 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x729 $x774 (not (and $x356 i2_prime $x142 $x344 $x835 $x1105 $x646 i8_prime)) (not (and $x299 i2_prime $x344 $x835 $x1105 $x646 i10_prime)) (not (and $x835 i2_prime $x344 $x646 $x311 i12_prime)))))
 (let (($x759 (and (not $x685) (not $x362) (not (and $x794 i2_prime $x964 $x295 i14_prime)) (not (and $x794 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x729 $x947 (not (and $x850 i2_prime $x75 $x964 $x794 $x745 $x789 i8_prime)) (not (and $x285 i2_prime $x964 $x794 $x745 $x789 i10_prime)) (not (and $x794 i2_prime $x964 $x789 $x297 i12_prime)))))
 (let (($x443 (and (not $x362) (not (and $x794 i2_prime $x964 $x295 i14_prime)) (not (and $x794 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x729 $x947 (not (and $x850 i2_prime $x75 $x964 $x794 $x745 $x789 i8_prime)) (not (and $x285 i2_prime $x964 $x794 $x745 $x789 i10_prime)) (not (and $x794 i2_prime $x964 $x789 $x297 i12_prime)))))
 (let (($x352 (and (not $x1051) (not (and $x835 i2_prime $x344 $x309 i14_prime)) (not (and $x835 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x729 $x774 (not (and $x356 i2_prime $x142 $x344 $x835 $x1105 $x646 i8_prime)) (not (and $x299 i2_prime $x344 $x835 $x1105 $x646 i10_prime)) (not (and $x835 i2_prime $x344 $x646 $x311 i12_prime)) (not $x443))))
 (not (not (and (not $x352) (not $x759))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
