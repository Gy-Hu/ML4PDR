...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x685 (not (and $x701 i2_prime (not $x75) $x288 $x667 $x698 $x709 $x694 i6_prime))))
 (let (($x389 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x693 (and $x701 i2_prime (not $x75) (not $x288) $x290 $x667 $x698 $x709 $x694 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x666 (not (and $x677 i2_prime (not $x142) $x302 $x671 $x681 $x674 $x682 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x662 (and $x677 i2_prime (not $x142) (not $x302) $x304 $x671 $x681 $x674 $x682 i4_prime)))
 (let (($x664 (and (not $x662) (not (and $x681 i2_prime $x671 $x309 i14_prime)) (not (and $x681 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x389 $x666 (not (and $x677 i2_prime $x142 $x671 $x681 $x674 $x682 i8_prime)) (not (and $x299 i2_prime $x671 $x681 $x674 $x682 i10_prime)) (not (and $x681 i2_prime $x671 $x682 $x311 i12_prime)))))
 (let (($x647 (and (not $x664) (not $x693) (not (and $x698 i2_prime $x667 $x295 i14_prime)) (not (and $x698 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x389 $x685 (not (and $x701 i2_prime $x75 $x667 $x698 $x709 $x694 i8_prime)) (not (and $x285 i2_prime $x667 $x698 $x709 $x694 i10_prime)) (not (and $x698 i2_prime $x667 $x694 $x297 i12_prime)))))
 (let (($x652 (and (not $x693) (not (and $x698 i2_prime $x667 $x295 i14_prime)) (not (and $x698 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x389 $x685 (not (and $x701 i2_prime $x75 $x667 $x698 $x709 $x694 i8_prime)) (not (and $x285 i2_prime $x667 $x698 $x709 $x694 i10_prime)) (not (and $x698 i2_prime $x667 $x694 $x297 i12_prime)))))
 (let (($x653 (and (not $x662) (not (and $x681 i2_prime $x671 $x309 i14_prime)) (not (and $x681 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x389 $x666 (not (and $x677 i2_prime $x142 $x671 $x681 $x674 $x682 i8_prime)) (not (and $x299 i2_prime $x671 $x681 $x674 $x682 i10_prime)) (not (and $x681 i2_prime $x671 $x682 $x311 i12_prime)) (not $x652))))
 (not (not (and (not $x653) (not $x647))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
