...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x864 (not (and $x609 i2_prime (not $x75) $x288 $x591 $x975 $x984 $x889 i6_prime))))
 (let (($x496 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x780 (and $x609 i2_prime (not $x75) (not $x288) $x290 $x591 $x975 $x984 $x889 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x792 (not (and $x579 i2_prime (not $x142) $x302 $x801 $x606 $x521 $x483 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x593 (and $x579 i2_prime (not $x142) (not $x302) $x304 $x801 $x606 $x521 $x483 i4_prime)))
 (let (($x906 (and (not $x593) (not (and $x606 i2_prime $x801 $x309 i14_prime)) (not (and $x606 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x496 $x792 (not (and $x579 i2_prime $x142 $x801 $x606 $x521 $x483 i8_prime)) (not (and $x299 i2_prime $x801 $x606 $x521 $x483 i10_prime)) (not (and $x606 i2_prime $x801 $x483 $x311 i12_prime)))))
 (let (($x624 (and (not $x906) (not $x780) (not (and $x975 i2_prime $x591 $x295 i14_prime)) (not (and $x975 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x496 $x864 (not (and $x609 i2_prime $x75 $x591 $x975 $x984 $x889 i8_prime)) (not (and $x285 i2_prime $x591 $x975 $x984 $x889 i10_prime)) (not (and $x975 i2_prime $x591 $x889 $x297 i12_prime)))))
 (let (($x828 (and (not $x780) (not (and $x975 i2_prime $x591 $x295 i14_prime)) (not (and $x975 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x496 $x864 (not (and $x609 i2_prime $x75 $x591 $x975 $x984 $x889 i8_prime)) (not (and $x285 i2_prime $x591 $x975 $x984 $x889 i10_prime)) (not (and $x975 i2_prime $x591 $x889 $x297 i12_prime)))))
 (let (($x391 (and (not $x593) (not (and $x606 i2_prime $x801 $x309 i14_prime)) (not (and $x606 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x496 $x792 (not (and $x579 i2_prime $x142 $x801 $x606 $x521 $x483 i8_prime)) (not (and $x299 i2_prime $x801 $x606 $x521 $x483 i10_prime)) (not (and $x606 i2_prime $x801 $x483 $x311 i12_prime)) (not $x828))))
 (not (not (and (not $x391) (not $x624))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
