...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x899 (not (and $x418 i2_prime (not $x75) $x288 $x694 $x958 $x939 $x864 i6_prime))))
 (let (($x1081 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x801 (and $x418 i2_prime (not $x75) (not $x288) $x290 $x694 $x958 $x939 $x864 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x353 (not (and $x352 i2_prime (not $x142) $x302 $x975 $x609 $x586 $x483 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x984 (and $x352 i2_prime (not $x142) (not $x302) $x304 $x975 $x609 $x586 $x483 i4_prime)))
 (let (($x680 (and (not $x984) (not (and $x609 i2_prime $x975 $x309 i14_prime)) (not (and $x609 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x1081 $x353 (not (and $x352 i2_prime $x142 $x975 $x609 $x586 $x483 i8_prime)) (not (and $x299 i2_prime $x975 $x609 $x586 $x483 i10_prime)) (not (and $x609 i2_prime $x975 $x483 $x311 i12_prime)))))
 (let (($x566 (and (not $x680) (not $x801) (not (and $x958 i2_prime $x694 $x295 i14_prime)) (not (and $x958 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x1081 $x899 (not (and $x418 i2_prime $x75 $x694 $x958 $x939 $x864 i8_prime)) (not (and $x285 i2_prime $x694 $x958 $x939 $x864 i10_prime)) (not (and $x958 i2_prime $x694 $x864 $x297 i12_prime)))))
 (let (($x380 (and (not $x801) (not (and $x958 i2_prime $x694 $x295 i14_prime)) (not (and $x958 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x1081 $x899 (not (and $x418 i2_prime $x75 $x694 $x958 $x939 $x864 i8_prime)) (not (and $x285 i2_prime $x694 $x958 $x939 $x864 i10_prime)) (not (and $x958 i2_prime $x694 $x864 $x297 i12_prime)))))
 (let (($x1022 (and (not $x984) (not (and $x609 i2_prime $x975 $x309 i14_prime)) (not (and $x609 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x1081 $x353 (not (and $x352 i2_prime $x142 $x975 $x609 $x586 $x483 i8_prime)) (not (and $x299 i2_prime $x975 $x609 $x586 $x483 i10_prime)) (not (and $x609 i2_prime $x975 $x483 $x311 i12_prime)) (not $x380))))
 (not (not (and (not $x1022) (not $x566))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
