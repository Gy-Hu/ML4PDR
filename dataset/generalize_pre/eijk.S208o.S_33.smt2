...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x843 (not (and $x398 i2_prime (not $x75) $x288 $x958 $x438 $x788 $x581 i6_prime))))
 (let (($x426 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x473 (and $x398 i2_prime (not $x75) (not $x288) $x290 $x958 $x438 $x788 $x581 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x1074 (not (and $x792 i2_prime (not $x142) $x302 $x1036 $x970 $x609 $x814 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x892 (and $x792 i2_prime (not $x142) (not $x302) $x304 $x1036 $x970 $x609 $x814 i4_prime)))
 (let (($x627 (and (not $x892) (not (and $x970 i2_prime $x1036 $x309 i14_prime)) (not (and $x970 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x426 $x1074 (not (and $x792 i2_prime $x142 $x1036 $x970 $x609 $x814 i8_prime)) (not (and $x299 i2_prime $x1036 $x970 $x609 $x814 i10_prime)) (not (and $x970 i2_prime $x1036 $x814 $x311 i12_prime)))))
 (let (($x905 (and (not $x627) (not $x473) (not (and $x438 i2_prime $x958 $x295 i14_prime)) (not (and $x438 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x426 $x843 (not (and $x398 i2_prime $x75 $x958 $x438 $x788 $x581 i8_prime)) (not (and $x285 i2_prime $x958 $x438 $x788 $x581 i10_prime)) (not (and $x438 i2_prime $x958 $x581 $x297 i12_prime)))))
 (let (($x1005 (and (not $x473) (not (and $x438 i2_prime $x958 $x295 i14_prime)) (not (and $x438 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x426 $x843 (not (and $x398 i2_prime $x75 $x958 $x438 $x788 $x581 i8_prime)) (not (and $x285 i2_prime $x958 $x438 $x788 $x581 i10_prime)) (not (and $x438 i2_prime $x958 $x581 $x297 i12_prime)))))
 (let (($x1017 (and (not $x892) (not (and $x970 i2_prime $x1036 $x309 i14_prime)) (not (and $x970 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x426 $x1074 (not (and $x792 i2_prime $x142 $x1036 $x970 $x609 $x814 i8_prime)) (not (and $x299 i2_prime $x1036 $x970 $x609 $x814 i10_prime)) (not (and $x970 i2_prime $x1036 $x814 $x311 i12_prime)) (not $x1005))))
 (not (not (and (not $x1017) (not $x905))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
