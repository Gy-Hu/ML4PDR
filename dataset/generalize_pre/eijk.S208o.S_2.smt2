...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x644 (not (and $x333 i2_prime (not $x75) $x288 $x572 $x625 $x605 $x491 i6_prime))))
 (let (($x414 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x464 (and $x333 i2_prime (not $x75) (not $x288) $x290 $x572 $x625 $x605 $x491 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x611 (not (and $x342 i2_prime (not $x142) $x302 $x618 $x793 $x555 $x738 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x927 (and $x342 i2_prime (not $x142) (not $x302) $x304 $x618 $x793 $x555 $x738 i4_prime)))
 (let (($x466 (and (not $x927) (not (and $x793 i2_prime $x618 $x309 i14_prime)) (not (and $x793 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x414 $x611 (not (and $x342 i2_prime $x142 $x618 $x793 $x555 $x738 i8_prime)) (not (and $x299 i2_prime $x618 $x793 $x555 $x738 i10_prime)) (not (and $x793 i2_prime $x618 $x738 $x311 i12_prime)))))
 (let (($x786 (and (not $x466) (not $x464) (not (and $x625 i2_prime $x572 $x295 i14_prime)) (not (and $x625 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x414 $x644 (not (and $x333 i2_prime $x75 $x572 $x625 $x605 $x491 i8_prime)) (not (and $x285 i2_prime $x572 $x625 $x605 $x491 i10_prime)) (not (and $x625 i2_prime $x572 $x491 $x297 i12_prime)))))
 (let (($x612 (and (not $x464) (not (and $x625 i2_prime $x572 $x295 i14_prime)) (not (and $x625 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x414 $x644 (not (and $x333 i2_prime $x75 $x572 $x625 $x605 $x491 i8_prime)) (not (and $x285 i2_prime $x572 $x625 $x605 $x491 i10_prime)) (not (and $x625 i2_prime $x572 $x491 $x297 i12_prime)))))
 (let (($x789 (and (not $x927) (not (and $x793 i2_prime $x618 $x309 i14_prime)) (not (and $x793 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x414 $x611 (not (and $x342 i2_prime $x142 $x618 $x793 $x555 $x738 i8_prime)) (not (and $x299 i2_prime $x618 $x793 $x555 $x738 i10_prime)) (not (and $x793 i2_prime $x618 $x738 $x311 i12_prime)) (not $x612))))
 (not (not (and (not $x789) (not $x786))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
