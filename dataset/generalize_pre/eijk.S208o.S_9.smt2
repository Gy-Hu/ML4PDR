...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x483 (not (and $x989 i2_prime (not $x75) $x288 $x585 $x1031 $x614 $x593 i6_prime))))
 (let (($x859 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x1051 (and $x989 i2_prime (not $x75) (not $x288) $x290 $x585 $x1031 $x614 $x593 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x801 (not (and $x957 i2_prime (not $x142) $x302 $x506 $x889 $x964 $x487 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x843 (and $x957 i2_prime (not $x142) (not $x302) $x304 $x506 $x889 $x964 $x487 i4_prime)))
 (let (($x334 (and (not $x843) (not (and $x889 i2_prime $x506 $x309 i14_prime)) (not (and $x889 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x859 $x801 (not (and $x957 i2_prime $x142 $x506 $x889 $x964 $x487 i8_prime)) (not (and $x299 i2_prime $x506 $x889 $x964 $x487 i10_prime)) (not (and $x889 i2_prime $x506 $x487 $x311 i12_prime)))))
 (let (($x834 (and (not $x334) (not $x1051) (not (and $x1031 i2_prime $x585 $x295 i14_prime)) (not (and $x1031 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x859 $x483 (not (and $x989 i2_prime $x75 $x585 $x1031 $x614 $x593 i8_prime)) (not (and $x285 i2_prime $x585 $x1031 $x614 $x593 i10_prime)) (not (and $x1031 i2_prime $x585 $x593 $x297 i12_prime)))))
 (let (($x418 (and (not $x1051) (not (and $x1031 i2_prime $x585 $x295 i14_prime)) (not (and $x1031 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x859 $x483 (not (and $x989 i2_prime $x75 $x585 $x1031 $x614 $x593 i8_prime)) (not (and $x285 i2_prime $x585 $x1031 $x614 $x593 i10_prime)) (not (and $x1031 i2_prime $x585 $x593 $x297 i12_prime)))))
 (let (($x668 (and (not $x843) (not (and $x889 i2_prime $x506 $x309 i14_prime)) (not (and $x889 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x859 $x801 (not (and $x957 i2_prime $x142 $x506 $x889 $x964 $x487 i8_prime)) (not (and $x299 i2_prime $x506 $x889 $x964 $x487 i10_prime)) (not (and $x889 i2_prime $x506 $x487 $x311 i12_prime)) (not $x418))))
 (not (not (and (not $x668) (not $x834))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
