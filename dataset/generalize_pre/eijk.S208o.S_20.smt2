...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x1035 (not (and $x1080 i2_prime (not $x75) $x288 $x945 $x723 $x977 $x371 i6_prime))))
 (let (($x606 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x876 (and $x1080 i2_prime (not $x75) (not $x288) $x290 $x945 $x723 $x977 $x371 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x686 (not (and $x861 i2_prime (not $x142) $x302 $x680 $x967 $x448 $x474 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x493 (and $x861 i2_prime (not $x142) (not $x302) $x304 $x680 $x967 $x448 $x474 i4_prime)))
 (let (($x658 (and (not $x493) (not (and $x967 i2_prime $x680 $x309 i14_prime)) (not (and $x967 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x606 $x686 (not (and $x861 i2_prime $x142 $x680 $x967 $x448 $x474 i8_prime)) (not (and $x299 i2_prime $x680 $x967 $x448 $x474 i10_prime)) (not (and $x967 i2_prime $x680 $x474 $x311 i12_prime)))))
 (let (($x677 (and (not $x658) (not $x876) (not (and $x723 i2_prime $x945 $x295 i14_prime)) (not (and $x723 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x606 $x1035 (not (and $x1080 i2_prime $x75 $x945 $x723 $x977 $x371 i8_prime)) (not (and $x285 i2_prime $x945 $x723 $x977 $x371 i10_prime)) (not (and $x723 i2_prime $x945 $x371 $x297 i12_prime)))))
 (let (($x601 (and (not $x876) (not (and $x723 i2_prime $x945 $x295 i14_prime)) (not (and $x723 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x606 $x1035 (not (and $x1080 i2_prime $x75 $x945 $x723 $x977 $x371 i8_prime)) (not (and $x285 i2_prime $x945 $x723 $x977 $x371 i10_prime)) (not (and $x723 i2_prime $x945 $x371 $x297 i12_prime)))))
 (let (($x1008 (and (not $x493) (not (and $x967 i2_prime $x680 $x309 i14_prime)) (not (and $x967 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x606 $x686 (not (and $x861 i2_prime $x142 $x680 $x967 $x448 $x474 i8_prime)) (not (and $x299 i2_prime $x680 $x967 $x448 $x474 i10_prime)) (not (and $x967 i2_prime $x680 $x474 $x311 i12_prime)) (not $x601))))
 (not (not (and (not $x1008) (not $x677))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
