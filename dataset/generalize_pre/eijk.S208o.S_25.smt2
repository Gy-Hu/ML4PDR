...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x426 (not (and $x731 i2_prime (not $x75) $x288 $x502 $x782 $x615 $x1045 i6_prime))))
 (let (($x649 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x565 (and $x731 i2_prime (not $x75) (not $x288) $x290 $x502 $x782 $x615 $x1045 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x656 (not (and $x452 i2_prime (not $x142) $x302 $x1069 $x522 $x511 $x908 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x572 (and $x452 i2_prime (not $x142) (not $x302) $x304 $x1069 $x522 $x511 $x908 i4_prime)))
 (let (($x942 (and (not $x572) (not (and $x522 i2_prime $x1069 $x309 i14_prime)) (not (and $x522 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x649 $x656 (not (and $x452 i2_prime $x142 $x1069 $x522 $x511 $x908 i8_prime)) (not (and $x299 i2_prime $x1069 $x522 $x511 $x908 i10_prime)) (not (and $x522 i2_prime $x1069 $x908 $x311 i12_prime)))))
 (let (($x768 (and (not $x942) (not $x565) (not (and $x782 i2_prime $x502 $x295 i14_prime)) (not (and $x782 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x649 $x426 (not (and $x731 i2_prime $x75 $x502 $x782 $x615 $x1045 i8_prime)) (not (and $x285 i2_prime $x502 $x782 $x615 $x1045 i10_prime)) (not (and $x782 i2_prime $x502 $x1045 $x297 i12_prime)))))
 (let (($x469 (and (not $x565) (not (and $x782 i2_prime $x502 $x295 i14_prime)) (not (and $x782 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x649 $x426 (not (and $x731 i2_prime $x75 $x502 $x782 $x615 $x1045 i8_prime)) (not (and $x285 i2_prime $x502 $x782 $x615 $x1045 i10_prime)) (not (and $x782 i2_prime $x502 $x1045 $x297 i12_prime)))))
 (let (($x727 (and (not $x572) (not (and $x522 i2_prime $x1069 $x309 i14_prime)) (not (and $x522 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x649 $x656 (not (and $x452 i2_prime $x142 $x1069 $x522 $x511 $x908 i8_prime)) (not (and $x299 i2_prime $x1069 $x522 $x511 $x908 i10_prime)) (not (and $x522 i2_prime $x1069 $x908 $x311 i12_prime)) (not $x469))))
 (not (not (and (not $x727) (not $x768))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
