...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x594 (not (and $x979 i2_prime (not $x75) $x288 $x561 $x1050 $x845 $x1052 i6_prime))))
 (let (($x1054 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x924 (and $x979 i2_prime (not $x75) (not $x288) $x290 $x561 $x1050 $x845 $x1052 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x815 (not (and $x764 i2_prime (not $x142) $x302 $x557 $x583 $x357 $x1085 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x794 (and $x764 i2_prime (not $x142) (not $x302) $x304 $x557 $x583 $x357 $x1085 i4_prime)))
 (let (($x857 (and (not $x794) (not (and $x583 i2_prime $x557 $x309 i14_prime)) (not (and $x583 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x1054 $x815 (not (and $x764 i2_prime $x142 $x557 $x583 $x357 $x1085 i8_prime)) (not (and $x299 i2_prime $x557 $x583 $x357 $x1085 i10_prime)) (not (and $x583 i2_prime $x557 $x1085 $x311 i12_prime)))))
 (let (($x1010 (and (not $x857) (not $x924) (not (and $x1050 i2_prime $x561 $x295 i14_prime)) (not (and $x1050 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x1054 $x594 (not (and $x979 i2_prime $x75 $x561 $x1050 $x845 $x1052 i8_prime)) (not (and $x285 i2_prime $x561 $x1050 $x845 $x1052 i10_prime)) (not (and $x1050 i2_prime $x561 $x1052 $x297 i12_prime)))))
 (let (($x402 (and (not $x924) (not (and $x1050 i2_prime $x561 $x295 i14_prime)) (not (and $x1050 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x1054 $x594 (not (and $x979 i2_prime $x75 $x561 $x1050 $x845 $x1052 i8_prime)) (not (and $x285 i2_prime $x561 $x1050 $x845 $x1052 i10_prime)) (not (and $x1050 i2_prime $x561 $x1052 $x297 i12_prime)))))
 (let (($x961 (and (not $x794) (not (and $x583 i2_prime $x557 $x309 i14_prime)) (not (and $x583 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x1054 $x815 (not (and $x764 i2_prime $x142 $x557 $x583 $x357 $x1085 i8_prime)) (not (and $x299 i2_prime $x557 $x583 $x357 $x1085 i10_prime)) (not (and $x583 i2_prime $x557 $x1085 $x311 i12_prime)) (not $x402))))
 (not (not (and (not $x961) (not $x1010))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
