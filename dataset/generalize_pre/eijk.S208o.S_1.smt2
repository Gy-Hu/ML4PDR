...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x370 (not (and $x592 i2_prime (not $x75) $x288 $x636 $x357 $x874 $x484 i6_prime))))
 (let (($x372 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x591 (and $x592 i2_prime (not $x75) (not $x288) $x290 $x636 $x357 $x874 $x484 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x631 (not (and $x655 i2_prime (not $x142) $x302 $x489 $x590 $x723 $x576 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x717 (and $x655 i2_prime (not $x142) (not $x302) $x304 $x489 $x590 $x723 $x576 i4_prime)))
 (let (($x566 (and (not $x717) (not (and $x590 i2_prime $x489 $x309 i14_prime)) (not (and $x590 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x372 $x631 (not (and $x655 i2_prime $x142 $x489 $x590 $x723 $x576 i8_prime)) (not (and $x299 i2_prime $x489 $x590 $x723 $x576 i10_prime)) (not (and $x590 i2_prime $x489 $x576 $x311 i12_prime)))))
 (let (($x581 (and (not $x566) (not $x591) (not (and $x357 i2_prime $x636 $x295 i14_prime)) (not (and $x357 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x372 $x370 (not (and $x592 i2_prime $x75 $x636 $x357 $x874 $x484 i8_prime)) (not (and $x285 i2_prime $x636 $x357 $x874 $x484 i10_prime)) (not (and $x357 i2_prime $x636 $x484 $x297 i12_prime)))))
 (let (($x613 (and (not $x591) (not (and $x357 i2_prime $x636 $x295 i14_prime)) (not (and $x357 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x372 $x370 (not (and $x592 i2_prime $x75 $x636 $x357 $x874 $x484 i8_prime)) (not (and $x285 i2_prime $x636 $x357 $x874 $x484 i10_prime)) (not (and $x357 i2_prime $x636 $x484 $x297 i12_prime)))))
 (let (($x704 (and (not $x717) (not (and $x590 i2_prime $x489 $x309 i14_prime)) (not (and $x590 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x372 $x631 (not (and $x655 i2_prime $x142 $x489 $x590 $x723 $x576 i8_prime)) (not (and $x299 i2_prime $x489 $x590 $x723 $x576 i10_prime)) (not (and $x590 i2_prime $x489 $x576 $x311 i12_prime)) (not $x613))))
 (not (not (and (not $x704) (not $x581))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
