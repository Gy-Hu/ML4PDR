...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x565 (not (and $x944 i2_prime (not $x75) $x288 $x699 $x905 $x1037 $x1035 i6_prime))))
 (let (($x931 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x417 (and $x944 i2_prime (not $x75) (not $x288) $x290 $x699 $x905 $x1037 $x1035 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x692 (not (and $x470 i2_prime (not $x142) $x302 $x721 $x361 $x635 $x444 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x872 (and $x470 i2_prime (not $x142) (not $x302) $x304 $x721 $x361 $x635 $x444 i4_prime)))
 (let (($x668 (and (not $x872) (not (and $x361 i2_prime $x721 $x309 i14_prime)) (not (and $x361 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x931 $x692 (not (and $x470 i2_prime $x142 $x721 $x361 $x635 $x444 i8_prime)) (not (and $x299 i2_prime $x721 $x361 $x635 $x444 i10_prime)) (not (and $x361 i2_prime $x721 $x444 $x311 i12_prime)))))
 (let (($x544 (and (not $x668) (not $x417) (not (and $x905 i2_prime $x699 $x295 i14_prime)) (not (and $x905 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x931 $x565 (not (and $x944 i2_prime $x75 $x699 $x905 $x1037 $x1035 i8_prime)) (not (and $x285 i2_prime $x699 $x905 $x1037 $x1035 i10_prime)) (not (and $x905 i2_prime $x699 $x1035 $x297 i12_prime)))))
 (let (($x421 (and (not $x417) (not (and $x905 i2_prime $x699 $x295 i14_prime)) (not (and $x905 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x931 $x565 (not (and $x944 i2_prime $x75 $x699 $x905 $x1037 $x1035 i8_prime)) (not (and $x285 i2_prime $x699 $x905 $x1037 $x1035 i10_prime)) (not (and $x905 i2_prime $x699 $x1035 $x297 i12_prime)))))
 (let (($x352 (and (not $x872) (not (and $x361 i2_prime $x721 $x309 i14_prime)) (not (and $x361 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x931 $x692 (not (and $x470 i2_prime $x142 $x721 $x361 $x635 $x444 i8_prime)) (not (and $x299 i2_prime $x721 $x361 $x635 $x444 i10_prime)) (not (and $x361 i2_prime $x721 $x444 $x311 i12_prime)) (not $x421))))
 (not (not (and (not $x352) (not $x544))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
