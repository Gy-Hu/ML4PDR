...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x1078 (not (and $x609 i2_prime (not $x75) $x288 $x567 $x555 $x799 $x494 i6_prime))))
 (let (($x451 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x733 (and $x609 i2_prime (not $x75) (not $x288) $x290 $x567 $x555 $x799 $x494 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x759 (not (and $x348 i2_prime (not $x142) $x302 $x413 $x670 $x507 $x389 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x806 (and $x348 i2_prime (not $x142) (not $x302) $x304 $x413 $x670 $x507 $x389 i4_prime)))
 (let (($x560 (and (not $x806) (not (and $x670 i2_prime $x413 $x309 i14_prime)) (not (and $x670 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x451 $x759 (not (and $x348 i2_prime $x142 $x413 $x670 $x507 $x389 i8_prime)) (not (and $x299 i2_prime $x413 $x670 $x507 $x389 i10_prime)) (not (and $x670 i2_prime $x413 $x389 $x311 i12_prime)))))
 (let (($x559 (and (not $x560) (not $x733) (not (and $x555 i2_prime $x567 $x295 i14_prime)) (not (and $x555 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x451 $x1078 (not (and $x609 i2_prime $x75 $x567 $x555 $x799 $x494 i8_prime)) (not (and $x285 i2_prime $x567 $x555 $x799 $x494 i10_prime)) (not (and $x555 i2_prime $x567 $x494 $x297 i12_prime)))))
 (let (($x1047 (and (not $x733) (not (and $x555 i2_prime $x567 $x295 i14_prime)) (not (and $x555 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x451 $x1078 (not (and $x609 i2_prime $x75 $x567 $x555 $x799 $x494 i8_prime)) (not (and $x285 i2_prime $x567 $x555 $x799 $x494 i10_prime)) (not (and $x555 i2_prime $x567 $x494 $x297 i12_prime)))))
 (let (($x649 (and (not $x806) (not (and $x670 i2_prime $x413 $x309 i14_prime)) (not (and $x670 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x451 $x759 (not (and $x348 i2_prime $x142 $x413 $x670 $x507 $x389 i8_prime)) (not (and $x299 i2_prime $x413 $x670 $x507 $x389 i10_prime)) (not (and $x670 i2_prime $x413 $x389 $x311 i12_prime)) (not $x1047))))
 (not (not (and (not $x649) (not $x559))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
