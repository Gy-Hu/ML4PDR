...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x977 (not (and $x995 i2_prime (not $x75) $x288 $x846 $x333 $x775 $x588 i6_prime))))
 (let (($x351 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x986 (and $x995 i2_prime (not $x75) (not $x288) $x290 $x846 $x333 $x775 $x588 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x776 (not (and $x603 i2_prime (not $x142) $x302 $x661 $x358 $x801 $x496 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x436 (and $x603 i2_prime (not $x142) (not $x302) $x304 $x661 $x358 $x801 $x496 i4_prime)))
 (let (($x480 (and (not $x436) (not (and $x358 i2_prime $x661 $x309 i14_prime)) (not (and $x358 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x351 $x776 (not (and $x603 i2_prime $x142 $x661 $x358 $x801 $x496 i8_prime)) (not (and $x299 i2_prime $x661 $x358 $x801 $x496 i10_prime)) (not (and $x358 i2_prime $x661 $x496 $x311 i12_prime)))))
 (let (($x947 (and (not $x480) (not $x986) (not (and $x333 i2_prime $x846 $x295 i14_prime)) (not (and $x333 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x351 $x977 (not (and $x995 i2_prime $x75 $x846 $x333 $x775 $x588 i8_prime)) (not (and $x285 i2_prime $x846 $x333 $x775 $x588 i10_prime)) (not (and $x333 i2_prime $x846 $x588 $x297 i12_prime)))))
 (let (($x962 (and (not $x986) (not (and $x333 i2_prime $x846 $x295 i14_prime)) (not (and $x333 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x351 $x977 (not (and $x995 i2_prime $x75 $x846 $x333 $x775 $x588 i8_prime)) (not (and $x285 i2_prime $x846 $x333 $x775 $x588 i10_prime)) (not (and $x333 i2_prime $x846 $x588 $x297 i12_prime)))))
 (let (($x939 (and (not $x436) (not (and $x358 i2_prime $x661 $x309 i14_prime)) (not (and $x358 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x351 $x776 (not (and $x603 i2_prime $x142 $x661 $x358 $x801 $x496 i8_prime)) (not (and $x299 i2_prime $x661 $x358 $x801 $x496 i10_prime)) (not (and $x358 i2_prime $x661 $x496 $x311 i12_prime)) (not $x962))))
 (not (not (and (not $x939) (not $x947))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
