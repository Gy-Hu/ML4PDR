...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x805 (not (and $x995 i2_prime (not $x75) $x288 $x686 $x1017 $x405 $x701 i6_prime))))
 (let (($x935 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x1031 (and $x995 i2_prime (not $x75) (not $x288) $x290 $x686 $x1017 $x405 $x701 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x912 (not (and $x898 i2_prime (not $x142) $x302 $x847 $x706 $x677 $x812 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x671 (and $x898 i2_prime (not $x142) (not $x302) $x304 $x847 $x706 $x677 $x812 i4_prime)))
 (let (($x977 (and (not $x671) (not (and $x706 i2_prime $x847 $x309 i14_prime)) (not (and $x706 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x935 $x912 (not (and $x898 i2_prime $x142 $x847 $x706 $x677 $x812 i8_prime)) (not (and $x299 i2_prime $x847 $x706 $x677 $x812 i10_prime)) (not (and $x706 i2_prime $x847 $x812 $x311 i12_prime)))))
 (let (($x637 (and (not $x977) (not $x1031) (not (and $x1017 i2_prime $x686 $x295 i14_prime)) (not (and $x1017 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x935 $x805 (not (and $x995 i2_prime $x75 $x686 $x1017 $x405 $x701 i8_prime)) (not (and $x285 i2_prime $x686 $x1017 $x405 $x701 i10_prime)) (not (and $x1017 i2_prime $x686 $x701 $x297 i12_prime)))))
 (let (($x456 (and (not $x1031) (not (and $x1017 i2_prime $x686 $x295 i14_prime)) (not (and $x1017 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x935 $x805 (not (and $x995 i2_prime $x75 $x686 $x1017 $x405 $x701 i8_prime)) (not (and $x285 i2_prime $x686 $x1017 $x405 $x701 i10_prime)) (not (and $x1017 i2_prime $x686 $x701 $x297 i12_prime)))))
 (let (($x365 (and (not $x671) (not (and $x706 i2_prime $x847 $x309 i14_prime)) (not (and $x706 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x935 $x912 (not (and $x898 i2_prime $x142 $x847 $x706 $x677 $x812 i8_prime)) (not (and $x299 i2_prime $x847 $x706 $x677 $x812 i10_prime)) (not (and $x706 i2_prime $x847 $x812 $x311 i12_prime)) (not $x456))))
 (not (not (and (not $x365) (not $x637))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
