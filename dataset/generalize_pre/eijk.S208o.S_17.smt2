...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x792 (not (and $x575 i2_prime (not $x75) $x288 $x990 $x343 $x389 $x592 i6_prime))))
 (let (($x699 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x501 (and $x575 i2_prime (not $x75) (not $x288) $x290 $x990 $x343 $x389 $x592 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x483 (not (and $x763 i2_prime (not $x142) $x302 $x940 $x629 $x620 $x854 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x915 (and $x763 i2_prime (not $x142) (not $x302) $x304 $x940 $x629 $x620 $x854 i4_prime)))
 (let (($x864 (and (not $x915) (not (and $x629 i2_prime $x940 $x309 i14_prime)) (not (and $x629 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x699 $x483 (not (and $x763 i2_prime $x142 $x940 $x629 $x620 $x854 i8_prime)) (not (and $x299 i2_prime $x940 $x629 $x620 $x854 i10_prime)) (not (and $x629 i2_prime $x940 $x854 $x311 i12_prime)))))
 (let (($x627 (and (not $x864) (not $x501) (not (and $x343 i2_prime $x990 $x295 i14_prime)) (not (and $x343 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x699 $x792 (not (and $x575 i2_prime $x75 $x990 $x343 $x389 $x592 i8_prime)) (not (and $x285 i2_prime $x990 $x343 $x389 $x592 i10_prime)) (not (and $x343 i2_prime $x990 $x592 $x297 i12_prime)))))
 (let (($x593 (and (not $x501) (not (and $x343 i2_prime $x990 $x295 i14_prime)) (not (and $x343 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x699 $x792 (not (and $x575 i2_prime $x75 $x990 $x343 $x389 $x592 i8_prime)) (not (and $x285 i2_prime $x990 $x343 $x389 $x592 i10_prime)) (not (and $x343 i2_prime $x990 $x592 $x297 i12_prime)))))
 (let (($x817 (and (not $x915) (not (and $x629 i2_prime $x940 $x309 i14_prime)) (not (and $x629 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x699 $x483 (not (and $x763 i2_prime $x142 $x940 $x629 $x620 $x854 i8_prime)) (not (and $x299 i2_prime $x940 $x629 $x620 $x854 i10_prime)) (not (and $x629 i2_prime $x940 $x854 $x311 i12_prime)) (not $x593))))
 (not (not (and (not $x817) (not $x627))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
