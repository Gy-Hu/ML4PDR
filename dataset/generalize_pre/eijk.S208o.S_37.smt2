...
(assert
 ...
 (let (($x288 (not $x81)))
 (let (($x556 (not (and $x1067 i2_prime (not $x75) $x288 $x336 $x393 $x443 $x631 i6_prime))))
 (let (($x386 (not (and i20_prime i2_prime))))
 (let (($x91 (and (not (and (and (not v28) v26) (and (and $x60 v22) v24))) (not (and (not (and (and v26 v24) (and $x60 v22))) v28)))))
 (let (($x290 (not $x91)))
 (let (($x370 (and $x1067 i2_prime (not $x75) (not $x288) $x290 $x336 $x393 $x443 $x631 i4_prime)))
 ...
 (let (($x302 (not $x148)))
 (let (($x415 (not (and $x685 i2_prime (not $x142) $x302 $x760 $x362 $x651 $x812 i6_prime))))
 (let (($x158 (and (not (and (and (not v44) v42) (and (and $x127 v38) v40))) (not (and (not (and (and v42 v40) (and $x127 v38))) v44)))))
 (let (($x304 (not $x158)))
 (let (($x799 (and $x685 i2_prime (not $x142) (not $x302) $x304 $x760 $x362 $x651 $x812 i4_prime)))
 (let (($x391 (and (not $x799) (not (and $x362 i2_prime $x760 $x309 i14_prime)) (not (and $x362 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x386 $x415 (not (and $x685 i2_prime $x142 $x760 $x362 $x651 $x812 i8_prime)) (not (and $x299 i2_prime $x760 $x362 $x651 $x812 i10_prime)) (not (and $x362 i2_prime $x760 $x812 $x311 i12_prime)))))
 (let (($x579 (and (not $x391) (not $x370) (not (and $x393 i2_prime $x336 $x295 i14_prime)) (not (and $x393 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x386 $x556 (not (and $x1067 i2_prime $x75 $x336 $x393 $x443 $x631 i8_prime)) (not (and $x285 i2_prime $x336 $x393 $x443 $x631 i10_prime)) (not (and $x393 i2_prime $x336 $x631 $x297 i12_prime)))))
 (let (($x976 (and (not $x370) (not (and $x393 i2_prime $x336 $x295 i14_prime)) (not (and $x393 i2_prime $x106 i16_prime)) (not (and $x292 i2_prime i18_prime)) $x386 $x556 (not (and $x1067 i2_prime $x75 $x336 $x393 $x443 $x631 i8_prime)) (not (and $x285 i2_prime $x336 $x393 $x443 $x631 i10_prime)) (not (and $x393 i2_prime $x336 $x631 $x297 i12_prime)))))
 (let (($x716 (and (not $x799) (not (and $x362 i2_prime $x760 $x309 i14_prime)) (not (and $x362 i2_prime $x172 i16_prime)) (not (and $x306 i2_prime i18_prime)) $x386 $x415 (not (and $x685 i2_prime $x142 $x760 $x362 $x651 $x812 i8_prime)) (not (and $x299 i2_prime $x760 $x362 $x651 $x812 i10_prime)) (not (and $x362 i2_prime $x760 $x812 $x311 i12_prime)) (not $x976))))
 (not (not (and (not $x716) (not $x579))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
