; benchmark generated from python AP|I
...
(assert
 ...
 (let (($x360 (not (and (not (and $x354 $x367 $x363 $x355 $x350 $x222 (not |i8'|))) $x355))))
 (let (($x339 (and (not (and $x354 $x367 $x363 $x355 $x350 $x222 (not |i8'|) (not |i6'|))) $x367)))
 (let (($x323 (not $x339)))
 (let (($x227 (not |i4'|)))
 (let (($x174 (not |i6'|)))
 (let (($x186 (not |i8'|)))
 (let (($x342 (not (and (not (and $x354 $x367 $x363 $x355 $x350 $x222 $x186 $x174 $x227)) $x363))))
 (let (($x155 (and (not (and $x342 |i2'| $x323 |i4'|)) (not (and $x342 |i2'| $x360 |i6'|)) (not (and $x342 |i2'| $x325 |i8'|)) (not (and $x342 |i2'| $x348 |i10'|)) (not (and $x323 |i4'| $x360 |i6'|)) (not (and $x323 |i4'| $x325 |i8'|)) (not (and $x323 |i4'| $x348 |i10'|)) (not (and $x360 |i6'| $x325 |i8'|)) (not (and $x360 |i6'| $x348 |i10'|)) (not (and $x348 |i10'| $x325 |i8'|)))))
 (not (not $x155)))))))))))))))))))
(check-sat)
